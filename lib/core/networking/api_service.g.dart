...
class _ApiService implements ApiService {
  _ApiService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://reqres.in/api/app-users';
  }
  ...
  Future<VerificationResponseModel> verify(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(verifyRequestBodyModel.toJson());
  ...
  @override
  Future<UsersResponseModel> fetchUsers(int page, int limit) async {
    final _extra = <String, dynamic>{};
    ...
    final _options = _setStreamType<UsersResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://reqres.in/api/collections/users_data/records',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
