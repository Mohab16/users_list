...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UsersState<T>);
}
...
/// @nodoc
class $UsersStateCopyWith<T,$Res>  {
$UsersStateCopyWith(UsersState<T> _, $Res Function(UsersState<T>) __);
}


/// Adds pattern-matching-related methods to [UsersState].
extension UsersStatePatterns<T> on UsersState<T> {
...
class _Initial<T> implements UsersState<T> {
  const _Initial();
...
class Loading<T> implements UsersState<T> {
  const Loading();
...
class Success<T> implements UsersState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $UsersStateCopyWith<T, $Res> {
...
class Error<T> implements UsersState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $UsersStateCopyWith<T, $Res> {
