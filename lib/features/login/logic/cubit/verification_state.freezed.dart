...
class Loading<T> implements VerificationState<T> {
  const Loading();
...
class Success<T> implements VerificationState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $VerificationStateCopyWith<T, $Res> {
...
class Error<T> implements VerificationState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $VerificationStateCopyWith<T, $Res> {
